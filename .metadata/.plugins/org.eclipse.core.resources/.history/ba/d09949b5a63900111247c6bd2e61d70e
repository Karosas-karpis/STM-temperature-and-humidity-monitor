...
#define SCVI_STATECHART_MAIN_REGION_SYS_STOP 0
...
typedef enum
{
	...
	Statechart_main_region_SYS_STOP,
...
{
	sc_boolean ev_RTC_Alarm_raised;
...
/*! Raises the in event 'ev_RTC_Alarm' that is defined in the default interface scope. */ 
extern void statechart_raise_ev_RTC_Alarm(Statechart* handle);
/*! Gets the value of the variable 'sample_no' that is defined in the default interface scope. */ 
extern sc_integer statechart_get_sample_no(const Statechart* handle);
/*! Sets the value of the variable 'sample_no' that is defined in the default interface scope. */ 
extern void statechart_set_sample_no(Statechart* handle, sc_integer value);
